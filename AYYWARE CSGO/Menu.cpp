...
#pragma region Aimbot
	...
	AimbotGroup.PlaceLabledControl("启用", this, &AimbotEnable);
	...
	AimbotGroup.PlaceLabledControl("瞄准范围", this, &AimbotFov);
	...
	AimbotGroup.PlaceLabledControl("完美静默自瞄", this, &AimbotPerfectSilentAim);
	...
	AimbotGroup.PlaceLabledControl("按键启动", this, &AimbotKeyPress);

	AimbotKeyBind.SetFileId("aim_key");
	AimbotGroup.PlaceLabledControl("按键绑定", this, &AimbotKeyBind);

	AimbotStopKey.SetFileId("aim_stop");
	AimbotGroup.PlaceLabledControl("停止自瞄按键", this, &AimbotStopKey);
...
#pragma region Target
	...
	TargetSelection.AddItem("靠近准心");
	TargetSelection.AddItem("距离");
	TargetSelection.AddItem("低血量");
	TargetGroup.PlaceLabledControl("目标选择", this, &TargetSelection);

	TargetFriendlyFire.SetFileId("tgt_friendlyfire");
	TargetGroup.PlaceLabledControl("射击时无视友军", this, &TargetFriendlyFire);

	TargetHitbox.SetFileId("tgt_hitbox");
	TargetHitbox.AddItem("头");
	TargetHitbox.AddItem("脖子");
	TargetHitbox.AddItem("胸部");
	TargetHitbox.AddItem("腹部");
	TargetHitbox.AddItem("腿部");
	TargetGroup.PlaceLabledControl("射击部位", this, &TargetHitbox);

	TargetHitscan.SetFileId("tgt_hitscan");
	TargetGroup.PlaceLabledControl("部位扫描", this, &TargetHitscan);

	TargetMultipoint.SetFileId("tgt_multipoint");
	TargetGroup.PlaceLabledControl("多个部位扫描", this, &TargetMultipoint);

	TargetPointscale.SetFileId("tgt_pointscale");
	TargetPointscale.SetBoundaries(0.f, 10.f);
	TargetPointscale.SetValue(5.f);
	TargetGroup.PlaceLabledControl("自瞄高度", this, &TargetPointscale);
...
#pragma region Accuracy
	...
	AccuracyGroup.PlaceLabledControl("无后坐力", this, &AccuracyRecoil);
	...
	AccuracyGroup.PlaceLabledControl("自动穿墙最小伤害", this, &AccuracyMinimumDamage);
	...
	AccuracyGroup.PlaceLabledControl("自动蹲下", this, &AccuracyAutoCrouch);

	AccuracyAutoScope.SetFileId("acc_scope");
	AccuracyGroup.PlaceLabledControl("自动开镜", this, &AccuracyAutoScope);

	AccuracyHitchance.SetFileId("acc_chance");
	AccuracyHitchance.SetBoundaries(0, 100);
	AccuracyHitchance.SetValue(10);
	AccuracyGroup.PlaceLabledControl("击中机率", this, &AccuracyHitchance);

	AccuracyResolver.SetFileId("acc_aaa");
	AccuracyResolver.AddItem("关闭");
	AccuracyResolver.AddItem("反自瞄修正");
	AccuracyResolver.AddItem("普通反自瞄修正");
	AccuracyResolver.AddItem("高级反自瞄修正");
	AccuracyResolver.AddItem("普通反自瞄修正2");
	AccuracyGroup.PlaceLabledControl("反自瞄修正", this, &AccuracyResolver);
	...
	AccuracyGroup.PlaceLabledControl("智能自瞄", this, &AccuracySmart);
...
#pragma region AntiAim
	...
	AntiAimGroup.PlaceLabledControl("启用", this, &AntiAimEnable);

	AntiAimPitch.SetFileId("aa_x");
	AntiAimPitch.AddItem("无");
	AntiAimPitch.AddItem("低头");
	AntiAimPitch.AddItem("SMAC Safe");
	AntiAimPitch.AddItem("乱抖");
	AntiAimPitch.AddItem("静止");
	AntiAimPitch.AddItem("假低头");
	AntiAimPitch.AddItem("模拟低头");
	AntiAimPitch.AddItem("模拟抬头");
	AntiAimGroup.PlaceLabledControl("X轴", this, &AntiAimPitch);

	AntiAimYaw.SetFileId("aa_y");
	AntiAimYaw.AddItem("无");
	AntiAimYaw.AddItem("假动");
	AntiAimYaw.AddItem("假侧身");
	AntiAimYaw.AddItem("假静止");
	AntiAimYaw.AddItem("T 乱抖");
	AntiAimYaw.AddItem("假乱斗");
	AntiAimYaw.AddItem("乱抖");
	AntiAimYaw.AddItem("T 乱抖");
	AntiAimYaw.AddItem("背身乱抖");
	AntiAimYaw.AddItem("背身");
	AntiAimYaw.AddItem("假蹲");
	AntiAimYaw.AddItem("随机");
	AntiAimGroup.PlaceLabledControl("Y轴", this, &AntiAimYaw);

	AntiAimEdge.SetFileId("aa_edge");
	AntiAimGroup.PlaceLabledControl("平滑", this, &AntiAimEdge);

	AntiAimOffset.SetFileId("aa_offset");
	AntiAimOffset.SetBoundaries(0, 360);
	AntiAimOffset.SetValue(69);
	AntiAimGroup.PlaceLabledControl("Y轴补偿", this, &AntiAimOffset);

	AntiAimKnife.SetFileId("aa_knife");
	AntiAimGroup.PlaceLabledControl("自动刀", this, &AntiAimKnife);

	AntiAimSpeed.SetFileId("aa_offset");
	AntiAimSpeed.SetBoundaries(0, 179.9);
	AntiAimSpeed.SetValue(69);
	AntiAimGroup.PlaceLabledControl("反自瞄速度", this, &AntiAimSpeed);
...
#pragma region Triggerbot
	...
	TriggerGroup.PlaceLabledControl("按键绑定", this, &TriggerKeyBind);
...
#pragma region Main Weapon
	...
	WeaponMainGroup.SetText("自动步枪/冲锋枪/重武器");
	...
	WeaponMainGroup.PlaceLabledControl("静默自瞄", this, &WeaponMainPSilent);

	WeaponMainInacc.SetFileId("main_inacc");
	WeaponMainInacc.SetBoundaries(0.f, 15.f);
	WeaponMainGroup.PlaceLabledControl("错误率", this, &WeaponMainInacc);
...
#pragma region Pistols
	...
	WeaponPistGroup.PlaceLabledControl("静默自瞄", this, &WeaponPistPSilent);

	WeaponPistInacc.SetFileId("pist_inacc");
	WeaponPistInacc.SetBoundaries(0.f, 15.f);
	WeaponPistInacc.SetValue(0.f);
	WeaponPistGroup.PlaceLabledControl("错误率", this, &WeaponPistInacc);
...
#pragma region Snipers
	...
	WeaponSnipGroup.PlaceLabledControl("范围", this, &WeaponSnipFoV);
	...
	WeaponSnipGroup.PlaceLabledControl("静默自瞄", this, &WeaponSnipPSilent);

	WeaponSnipInacc.SetFileId("wconf_inacc_ak");
	WeaponSnipInacc.SetBoundaries(0.f, 15.f);
	WeaponSnipGroup.PlaceLabledControl("错误率", this, &WeaponSnipInacc);
...
#pragma region Options
	...
	OptionsGroup.PlaceLabledControl("填充", this, &OptionsBoxFill);

	OptionsBox.SetFileId("opt_boxcolor");
	OptionsGroup.PlaceLabledControl("颜色填充", this, &OptionsBoxFillColor);
	...
	OptionsGroup.PlaceLabledControl("玩家段位", this, &OptionsCompRank);
...
#pragma region Filters
	...
	FiltersGroup.PlaceLabledControl("全部", this, &FiltersAll);
	...
	FiltersGroup.PlaceLabledControl("仅敌人", this, &FiltersEnemiesOnly);

	FiltersWeapons.SetFileId("ftr_weaps");
	FiltersGroup.PlaceLabledControl("武器", this, &FiltersWeapons);
...
#pragma region Other
	...
	OtherViewmodelFOV.SetValue(0.f);
	OtherGroup.PlaceLabledControl("模型距离", this, &OtherViewmodelFOV);

	OtherFOV.SetFileId("otr_fov");
	OtherFOV.SetBoundaries(0.f, 180.f);
	OtherFOV.SetValue(90.f);
	OtherGroup.PlaceLabledControl("视野距离", this, &OtherFOV);
...
#pragma region Other
	...
	OtherGroup.PlaceLabledControl("安全模式2.0", this, &OtherSafeMode);

	OtherChatSpam.SetFileId("otr_spam");
	OtherChatSpam.AddItem("关闭");
	OtherChatSpam.AddItem("GhostWare");
	OtherChatSpam.AddItem("随机改名");
	...
	OtherClantag.AddItem("GhostWare");
	...
	OtherGroup.PlaceLabledControl("队内发送", this, &OtherTeamChat);

	OtherChatDelay.SetFileId("otr_chatdelay");
	OtherChatDelay.SetBoundaries(0.1, 3.0);
	OtherChatDelay.SetValue(0.5);
	OtherGroup.PlaceLabledControl("刷屏间隔", this, &OtherChatDelay);
	...
	OtherGroup.PlaceLabledControl("第三人称", this, &OtherThirdperson);
...
#pragma MenuGroup
	...
	MenuBackround.PlaceLabledControl("透明", this, &MenuOpacity);
